    ...
    <section class="pt-6 pb-24 px-6">
      <div class="flex flex-wrap -m-4 mb-20">
        <div class="w-full lg:w-1/2 p-4">
          <a href="#" class="group">
            <div
              class="relative overflow-hidden rounded-xl transition duration-200 mb-4"
              style={{ height: "675px" }}
            >
              <img
                class="absolute inset-0 rounded-xl w-full h-full object-cover transform group-hover:scale-105 transition duration-200"
                src="shopky-assets/new-arrival/product9.png"
                alt=""
              />
            </div>
          </a>
          <div class="flex flex-wrap items-center justify-center gap-8">
            <a
              href="#"
              class="bg-white border border-gray-200 rounded-full hover:bg-gray-50 focus:ring-4 focus:ring-gray-200 text-black text-sm font-semibold w-14 h-14 flex items-center justify-center transition duration-200"
            >
              <svg
              ...
              >
                <path
                  d="M15.0531 16.5L19.7731 11.78C20.0214 11.5302 20.1608 11.1922 20.1608 10.84C20.1608 10.4877 20.0214 10.1498 19.7731 9.9C19.6491 9.77503 19.5017 9.67583 19.3392 9.60814C19.1767 9.54045 19.0024 9.5056 18.8264 9.5056C18.6504 9.5056 18.4761 9.54045 18.3137 9.60814C18.1512 9.67583 18.0037 9.77503 17.8798 9.9L12.2264 15.5533C12.1015 15.6773 12.0023 15.8247 11.9346 15.9872C11.8669 16.1497 11.832 16.324 11.832 16.5C11.832 16.676 11.8669 16.8503 11.9346 17.0128C12.0023 17.1752 12.1015 17.3227 12.2264 17.4467L17.8798 23.1667C18.0043 23.2902 18.1521 23.388 18.3146 23.4544C18.477 23.5207 18.651 23.5543 18.8264 23.5533C19.0019 23.5543 19.1759 23.5207 19.3383 23.4544C19.5008 23.388 19.6485 23.2902 19.7731 23.1667C20.0214 22.9168 20.1608 22.5789 20.1608 22.2267C20.1608 21.8744 20.0214 21.5365 19.7731 21.2867L15.0531 16.5Z"
                  fill="black"
                ></path>
              </svg>
            </a>
            <div class="flex flex-wrap justify-center gap-4">
              <a href="#" class="group">
                <div
                  class="relative overflow-hidden rounded-lg border border-gray-800 transition duration-200"
                  style={{ width: 125, height: 115 }}
                >
                  <img
                    class="absolute inset-0 rounded-lg w-full h-full object-cover transform group-hover:scale-105 transition duration-200"
                    src="shopky-assets/details-product/product-details4.png"
                    alt=""
                  />
                </div>
              </a>
              <a href="#" class="group">
                <div
                  class="relative overflow-hidden rounded-lg border-2 border-transparent group-hover:border-gray-800 transition duration-200"
                  style={{ width: 125, height: 115 }}
                >
                  <img
                    class="absolute inset-0 rounded-lg w-full h-full object-cover transform group-hover:scale-105 transition duration-200"
                    src="shopky-assets/details-product/product-details5.png"
                    alt=""
                  />
                </div>
              </a>
              <a href="#" class="group">
                ...
                >
                  <img
                    class="absolute inset-0 rounded-lg w-full h-full object-cover transform group-hover:scale-105 transition duration-200"
                    src="shopky-assets/details-product/product-details6.png"
                    alt=""
                  />
                </div>
              </a>
            ...
            >
              ...
              >
                <path
                  d="M16.9467 16.5L12.2267 21.22C11.9783 21.4698 11.8389 21.8078 11.8389 22.16C11.8389 22.5123 11.9783 22.8502 12.2267 23.1C12.3506 23.225 12.4981 23.3242 12.6606 23.3919C12.823 23.4595 12.9973 23.4944 13.1733 23.4944C13.3493 23.4944 13.5236 23.4595 13.6861 23.3919C13.8486 23.3242 13.996 23.225 14.12 23.1L19.7733 17.4467C19.8983 17.3227 19.9975 17.1753 20.0652 17.0128C20.1329 16.8503 20.1677 16.676 20.1677 16.5C20.1677 16.324 20.1329 16.1497 20.0652 15.9872C19.9975 15.8248 19.8983 15.6773 19.7733 15.5533L14.12 9.83334C13.9954 9.70976 13.8477 9.61199 13.6852 9.54564C13.5228 9.47929 13.3488 9.44565 13.1733 9.44667C12.9979 9.44565 12.8239 9.47929 12.6615 9.54564C12.499 9.61199 12.3512 9.70976 12.2267 9.83334C11.9783 10.0832 11.8389 10.4211 11.8389 10.7733C11.8389 11.1256 11.9783 11.4635 12.2267 11.7133L16.9467 16.5Z"
                  fill="black"
                ></path>
              </svg>
            </a>
        ...
        <div class="w-full lg:w-1/2 p-4">
          <div class="p-5 md:p-10">
            <h2 class="font-heading uppercase text-5xl mb-8 max-w-2xl">
              These soft maroon clothes are not only stylish, but also
              incredibly comfortable to wear for all skin types
            </h2>
            <p class="text-gray-500 text-xl font-semibold mb-8 max-w-2xl">
            ...
            <h2 class="font-heading text-4xl mb-8">$ 128.21</h2>
            <p class="font-semibold mb-4">Select Size</p>
            <div class="flex flex-wrap gap-6 items-center mb-8">
              <div class="flex flex-wrap gap-4">
                <a
                  href="#"
                  class="flex items-center justify-center w-10 h-10 p-2 rounded-lg border border-gray-100 hover:bg-gray-900 hover:text-white transition duration-200"
                >
                  XS
                </a>
                <a
              ...
              <a
                href="#"
                class="text-sm underline hover:text-gray-700 transition duration-200"
              >
                Size Guide
              </a>
            </div>
            ...
            <div class="flex flex-wrap gap-4 mb-14">
              ...
              <a href="#">
                <div class="rounded-full bg-red-700 border border-gray-100 w-12 h-12 flex items-center justify-center">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                    height="24"
      ...
      <h2 class="font-heading uppercase text-4xl mb-6">Recently Added</h2>
        ...
        <div class="w-full lg:w-1/3 p-4">
          <div class="group">
            ...
            >
              <a href="#">
                <img
                  class="rounded-xl object-cover w-full h-full transform group-hover:scale-105 transition duration-200"
              ...
              <div class="absolute top-4 left-4 right-4">
                <div class="flex justify-between flex-wrap gap-4">
                  <div class="flex flex-wrap gap-2">
                    <span class="inline-block bg-white rounded-full px-3 py-2 font-semibold">
                      New arrival
                    </span>
                    <span class="inline-block bg-white rounded-full px-3 py-2 font-semibold text-red-600">
                      30% OFF
                    </span>
                  </div>
                  <a
                    href="#"
                    class="bg-white border border-gray-200 rounded-full hover:bg-gray-50 focus:ring-4 focus:ring-gray-200 text-black text-sm font-semibold w-10 h-10 flex items-center justify-center transition duration-200"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
            ...
            <h2 class="font-heading uppercase text-3xl mb-3">
              Lorem product name dummy
            </h2>
            <p class="text-2xl font-semibold">$145.00</p>
          </div>
        </div>
        <div class="w-full lg:w-1/3 p-4">
          <div class="group">
            ...
            >
              <a href="#">
                <img
                  class="rounded-xl object-cover w-full h-full transform group-hover:scale-105 transition duration-200"
                  src="shopky-assets/new-arrival/product8.png"
                  alt=""
                />
              </a>
              <div class="absolute top-4 left-4 right-4">
